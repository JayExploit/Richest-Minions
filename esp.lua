...
function CreateEsp(Player)
    ...
    if Player.Character ~= nil and Player.Character:FindFirstChild("Humanoid") ~= nil and Player.Character:FindFirstChild("HumanoidRootPart") ~= nil and Player.Character.Humanoid.Health > 0 and Player.Character:FindFirstChild("Head") ~= nil then
            ...
            if Config.Box then
                ...
                if Player.leaderstats.HouseRank.Value == "Owner" and Player.leaderstats.Gender.Value == "Female" then
            ...
            if Config.Names then
                ...
                Name.Text = Player.leaderstats.HouseRank.Value.." "..Player.leaderstats.FirstName.Value.." "..Player.leaderstats.LastName.Value.." "..Player.leaderstats.UberTitle.Value.." "..math.floor((workspace.CurrentCamera.CFrame.p - Player.Character.HumanoidRootPart.Position).magnitude).."m"
                Name.Center = true
